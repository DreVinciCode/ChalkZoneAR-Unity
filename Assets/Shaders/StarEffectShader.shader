Shader "Unlit/StarEffect"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _Speed ("Color Speed", Range(1, 10)) = 10 
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float3 ViewDir = normalize(_WorldSpaceCameraPos.xyz - i.position_world.xyz);

                float fresnel = 1;
                Unity_FresnelEffect_float(normal_world, ViewDir, 1 , fresnel);
